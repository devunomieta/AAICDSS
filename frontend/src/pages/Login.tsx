    ...
    <div className="min-h-screen bg-background flex flex-col items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="flex flex-col items-center gap-3 mb-10">
          <div className="w-16 h-16 bg-primary/20 rounded-2xl flex items-center justify-center border border-primary/50 shadow-[0_0_30px_rgba(59,130,246,0.3)]">
            <Activity size={32} className="text-primary" />
          </div>
          <h1 className="text-3xl font-bold text-white tracking-tight mt-2">AffiongAI CDSS</h1>
          <p className="text-textMuted text-sm">Secure Clinical Decision Support</p>
        </div>
        ...
        <div className="bg-surface border border-border rounded-2xl p-8 shadow-2xl relative overflow-hidden">
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            <div>
              <label className="block text-sm font-medium text-gray-300 mb-1.5">Organizational Email</label>
        ...
        <p className="text-center text-sm text-gray-500 mt-8">
          Self-service signup is disabled for security.<br />Contact IT to provision a new clinical account.
        </p>
      </div>
    </div>
  );
